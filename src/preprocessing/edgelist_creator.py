...
class ValidCompartment(ValidContact):
    """
    Assessing the reliability of compartment calls by using reference databases and PCA plots
    """

    def __init__(self, config):
        super().__init__(config)
        # self.compartment_file = #set post configuring compartments output params for file name
        # self.compartment_list = #set from reading file a df containing chr
