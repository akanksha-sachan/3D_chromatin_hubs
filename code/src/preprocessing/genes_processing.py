...
def assignBins2Genes(infile, bins_files, ref_genome='hg38'):
    ...
    gene_chrom_bin_num.to_csv(f'/Users/Akanksha/MaGroup/Genomic Hubs/workflow/tmp/gene_chrom_bin_num_{ref_genome}_gm12878.txt', sep='\t', index=False)
...
if __name__ == "__main__":
    ...
    #save to file
    result_df.to_csv('/Users/Akanksha/MaGroup/Genomic Hubs/workflow/tmp/genes_binID_hg19_gm12878.txt', sep='\t')
