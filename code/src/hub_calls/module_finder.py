...
class Graph:
    def __init__(self, edge_list=None, matrix=None, projection=None, sample="", parent=None):
        """
        ...
        if edge_list is not None:
            ...
            raise ValueError("Either provide an edge list or a connectivity matrix with projection.")
    ...
    def initialize_inheritance(self):
        ...
        try:
            ...
            if self.cell:
                ...
                self.interval_table = pd.read_table(f"../Temp/{self.sample}/chrom_bin_index.txt", sep="\t")
            else:
